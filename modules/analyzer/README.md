...
| <a name="input_type"></a> [type](#input\_type) | (Optional) The type of analyzer. Valid values: ACCOUNT, ORGANIZATION, ACCOUNT\_UNUSED\_ACCESS, ORGANIZATION\_UNUSED\_ACCESS. | `string` | `"ORGANIZATION"` | no |
